...
exports.findOne = async (req, res) => {
  ...
  //FORECAST_RATING
  base_url="http://forecast_api_adapter:8080/api/forecasts/?"
  arguments_forecast = "lat=" + lat + "&" + "lon=" + lon + "&date=" + date

  url=base_url+arguments_forecast
  ...
  //CROWD_RATING
  base_url="http://crowd_api_adapter:8080/api/crowds/?"
  arguments_forecast = "lat=" + lat + "&" + "lon=" + lon
  ...
  //FINAL RATING
  const final_rating=(crowd_rating+forecast_rating*2)/3
